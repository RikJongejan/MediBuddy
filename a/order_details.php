...
// Get order details, ensuring it belongs to the current user
...
<head>
    ...
    <title>Order #<?php echo $order['id']; ?> - MediBuddy</title>
...
<body>
    ...
    <section class="section">
        <div class="container">
            <h1 class="page-title" data-aos="fade-up">Order Details</h1>
            
            <!-- Order Status Header -->
            <div class="order-status-header" data-aos="fade-up">
            ...
            <!-- Action Buttons -->
            <div class="order-actions" data-aos="fade-up">
                <a href="account.php" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Back to Orders</a>
                <?php if ($order['status'] != 'Cancelled' && $order['status'] != 'Delivered'): ?>
                    <a href="contact.php?subject=Order%20#<?php echo $order['id']; ?>" class="btn"><i class="fas fa-envelope"></i> Contact Support</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
