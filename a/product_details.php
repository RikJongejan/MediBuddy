    ...
    <div class="container">
        ...
        <div class="product-detail-grid" data-aos="fade-up">
            ...
            <div class="product-info">
                ...
                <?php if($product['stock_quantity'] > 0): ?>
                    <form action="javascript:void(0);" class="product-actions add-to-cart-form">
                        ...
                        <button type="button" class="btn btn-primary add-to-cart-btn" onclick="addToCart(<?php echo $product['id']; ?>, document.querySelector('.qty-input').value);">
...
// Add extra JS code for cart functionality
$extra_js = '
