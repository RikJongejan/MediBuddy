                ...
                <form method="post" action="">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-input" required value="<?php echo isset($name) ? htmlspecialchars($name) : ''; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="icon" class="form-label">Icon (emoji or FontAwesome class)</label>
                            <input type="text" id="icon" name="icon" class="form-input" placeholder="💊 or fa-pills" value="<?php echo isset($icon) ? htmlspecialchars($icon) : ''; ?>">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="description" class="form-label">Description</label>
                        <textarea id="description" name="description" class="form-input" rows="4"><?php echo isset($description) ? htmlspecialchars($description) : ''; ?></textarea>
                    </div>
