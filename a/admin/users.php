...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($userId == $_SESSION['user_id'] && $_GET['action'] == 'deactivate') {
        $warningMsg = "You cannot deactivate your own account.";
    } else {
        switch ($_GET['action']) {
            case 'activate':
                ...
                if ($stmt->execute()) {
                    ...
                    $errorMsg = "Failed to activate user: " . $conn->error;
                }
                break;
            ...
            case 'delete':
                // Check if it's not your own account
                if ($userId == $_SESSION['user_id']) {
                    $warningMsg = "You cannot delete your own account.";
                } else {
                    ...
                    if ($orderCount > 0) {
                        $warningMsg = "Cannot delete user. User has $orderCount orders associated with their account.";
                    } else {
    ...
    <div class="card-header">
        ...
        <form action="" method="GET" class="search-form">
            <div class="search-container">
                <input type="text" name="search" placeholder="Search by username or email..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>" class="form-control">
