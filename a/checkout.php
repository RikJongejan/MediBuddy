                ...
                <div class="order-summary">
                    <div class="admin-card">
                        ...
                        <div class="summary-row">
                            <span>Subtotal</span>
                            <span id="order-subtotal"><?php echo formatCurrency($subtotal); ?></span>
                        </div>
                        
                        <div class="summary-row">
                            <span>Shipping</span>
                            <span id="order-shipping"><?php echo formatCurrency($shipping_fee); ?></span>
                        </div>
                        
                        <div class="summary-total">
                            <span>Total</span>
                            <span id="order-total"><?php echo formatCurrency($total_price); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    getCartDetails()
        .then(items => {
            ...
            document.getElementById("order-shipping").textContent = shippingFee > 0 ? "$" + shippingFee.toFixed(2) : "FREE";
            document.getElementById("order-total").textContent = "$" + total.toFixed(2);
            
            // Add input field with cart data for the server
